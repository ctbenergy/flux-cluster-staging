# Deploying k3s backed by Flux

Deploying a single [k3s](https://k3s.io) cluster with [Ansible](https://www.ansible.com) and [Terraform](https://www.terraform.io) backed by [Flux](https://toolkit.fluxcd.io/) and [SOPS](https://toolkit.fluxcd.io/guides/mozilla-sops/).
...
- [Introduction](https://github.com/ctbenergy/flux-cluster-template#-introduction)
- [Prerequisites](https://github.com/ctbenergy/flux-cluster-template#-prerequisites)
- [Repository structure](https://github.com/ctbenergy/flux-cluster-template#-repository-structure)
- [Lets go!](https://github.com/ctbenergy/flux-cluster-template#-lets-go)
- [Post installation](https://github.com/ctbenergy/flux-cluster-template#-post-installation)
- [Troubleshooting](https://github.com/ctbenergy/flux-cluster-template#-troubleshooting)
- [What's next](https://github.com/ctbenergy/flux-cluster-template#-whats-next)
- [Thanks](https://github.com/ctbenergy/flux-cluster-template#-thanks)
...
- [Debian Server](https://www.debian.org/download) - Universal operating system that supports running all kinds of home related workloads in Kubernetes and has a faster release cycle
- [Ansible](https://www.ansible.com) - Provision Debian Server and install k3s
...
**Note:** _This repository has been tested on Netcup Root-Server
...
- One or more nodes with a fresh install of [Debian 11](https://www.debian.org/download).
...
📍 Nodes are not security hardened by default, you can do this with [dev-sec/ansible-collection-hardening](https://github.com/dev-sec/ansible-collection-hardening) or similar if it supports Debian Server.
...
5. Run the Debian Server Ansible prepare playbook
...
1. Webhook URL - Your webhook receiver will be deployed on `https://flux-receiver.${BOOTSTRAP_CLOUDFLARE_DOMAIN}/hook/:hookId`. In order to find out your hook id you can run the following command:
    ...
    So if my domain was `ctbenergy.com` the full url would look like this:

    ```text
    https://flux-receiver.ctbenergy.com/hook/12ebd1e363c641dc3c2e430ecf3cee2b3c7a5ac9e1234506f6f5f3ce1230e123
    ```
...
Our [wiki](https://github.com/ctbenergy/flux-cluster-template/wiki) (WIP, contributions welcome) is a good place to start troubleshooting issues. If that doesn't cover your issue, come join and say Hi in our community [Discord](https://discord.gg/k8s-at-home).
